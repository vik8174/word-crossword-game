...
One thing moves so far: the change from one screen of a room to the next ([issue #93](https://github.com/vik8174/word-crossword-game/issues/93)). What may move and what may not is decided in [ADR 0030](decisions/0030-where-movement-is-allowed.md), and every rule in it costs a step here.

Steps 1 to 3 are taken inside the session above, at the moments they name. Step 4 is taken in the second room, the one **Always** step 10 makes for a game ended early, and before that game is ended.
