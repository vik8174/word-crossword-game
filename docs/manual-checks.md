...
Steps 2 to 5 are taken inside the session above, from the deal onwards — there is no board before it. Step 1 is three rooms of its own and needs nobody to join them.
