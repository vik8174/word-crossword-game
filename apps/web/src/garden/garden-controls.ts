 ...
 *
 * It is two verbs and no state, on purpose. Whether petals are falling is the
 * garden's own business and nothing else's, and a screen that could read it
 * would sooner or later be written to decide something by it.
 */
 ...
 */
const NO_GARDEN: GardenControls = { showAir: () => {}, greet: () => {} };
